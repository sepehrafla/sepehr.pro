    ...
    return (
      <div className={css(styles.wrapper) + ' animated slideInDown'} style={{backgroundColor: this.state.backgroundColor, boxShadow: this.state.shadow}}>
        <div className={css(styles.titleWrapper)}>
          <ImageButton link='https://github.com/sepehrafla' width='40px' height='40px' src='Assets/Img/NavBar/github-logo.svg' />
        ...
        <div className={css(styles.navigationWrapper)}>
          ...
          <a href='https://github.com/sepehrafla' target='_blank' className={css(styles.navigationItem)} rel='noopener noreferrer'><div>Blog</div></a>
